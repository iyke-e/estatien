      ...
      <div className=" pt-20 hidden lg:block ">
        <div className="flex p-inline justify-between  items-start">
          <div className="grid  gap-4">
            ...
            <div
              className={
                "flex relative border rounded-lg border-gray-15 px-4 md:w-fit items-center"
              }
            >
              <RiMailUnreadLine className="w-6 h-6" />
              <input
                className="p-3 placeholder:text-sm w-full  outline-0"
                type="email"
        ...
        <div className=" flex-between mt-12 py-4 p-inline  bg-gray-10  gap-4 ">
          ...
          <ul className="flex items-center gap-2 justify-center">
            ...
            <li className="grid place-content-center square-14 rounded-full bg-gray-80">
              <a href="">
                <IoLogoYoutube className={"square-5"} />{" "}
              </a>
            </li>
          </ul>
        </div>
